...
<tr><td> <em>Generated: </em> 3/20/2023 5:38:49 PM</td></tr>
...
<tr><td> <a rel="noreferrer noopener" target="_blank" href="https://github.com/GraceBurke-88/IS601-004/pull/31">https://github.com/GraceBurke-88/IS601-004/pull/31</a> </td></tr>
<tr><td> <em>Sub-Task 2: </em> Explain any issues/difficulties or something you learned while doing this assignment</td></tr>
<tr><td> <em>Response:</em> <div>One issue I ran into was dealing with outputting the values as money<br>and losing trailing zeros during the type conversion (for example I wanted 4.00<br>but it was being stored as 4.0). To fix this I used format<br>for the string so that the cost and expected values were stored correctly.&nbsp;</div><br></td></tr>
<tr><td> <em>Sub-Task 3: </em> Screenshots of successful output</td></tr>
<tr><td><table><tr><td><img width="768px" src="https://user-images.githubusercontent.com/70772404/226471156-fa1bc9b2-335a-42a5-a15e-b32a8050a126.png"/></td></tr>
<tr><td> <em>Caption:</em> <p>Ordered two different burgers with different combinations. Shows handling of payment and some<br>exception handling.<br></p>
</td></tr>
